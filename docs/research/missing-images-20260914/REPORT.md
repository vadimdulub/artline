...
14 September 2026 · Artline existing catalogue · Final read-only audit: 2026-09-14T06:16:28.508408+00:00

**1,912 artwork records still without images have source-supported image candidates.** This pass assessed 2,191 distinct records: 1,949 fresh records and 242 explicit follow-ups. 1673 candidates belong to the fresh cohort. The follow-ups include all 238 previously failing Minneapolis image endpoints, now responding through the museum’s current image service, and four Greek or Byzantine identity questions. 279 records remain deferred and 0 were superseded by a concurrent catalogue change.
...
| Source | Assessed | Remaining candidates | Deferred | Superseded |
|---|---:|---:|---:|---:|
| Finnish National Gallery | 750 | 657 | 93 | 0 |
| Minneapolis Institute of Art | 638 | 506 | 132 | 0 |
| Smithsonian American Art Museum | 500 | 498 | 2 | 0 |
| Walters Art Museum | 250 | 249 | 1 | 0 |
| Additional Russian-priority museum records | 49 | 1 | 48 | 0 |
| Greek and Byzantine follow-ups | 4 | 1 | 3 | 0 |
