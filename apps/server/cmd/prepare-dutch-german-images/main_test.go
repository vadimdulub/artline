...
func TestBoundedEvidenceAndURL(t *testing.T) {
	e := map[string]any{"artwork_id": "bde58d01-8a1e-5a9b-9ad8-9175ff377b99", "source_image_url": "https://search.smb.museum/media/images/thumbs/extra_large/300/006/example.jpg", "identity_basis": "reviewed exact source identifier", "creator_credit": "Example photographer", "source_evidence_sha256": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "provider": "dutch-german-primary", "rights_status": "public_domain", "policy_url": "https://creativecommons.org/publicdomain/mark/1.0/", "checked_at": time.Now().UTC().Format(time.RFC3339)}
	...
	e["source_image_url"] = "https://search.smb.museum/media/images/thumbs/extra_large/300/006/example.jpg"
